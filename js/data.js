  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Decision", items: [
        ...
        { figure: [
          { src: `${IMG}/supplier/contact-center-before.webp`, alt: "The old Contacts page: names and emails grouped under role headings, with most roles showing no assigned owners", caption: "Contact Center, before" },
          { src: `${IMG}/supplier/contact-center-after.webp`, alt: "The redesigned Contact Center: a searchable, filterable table of contacts with permissions, status, and a detail panel for the selected person", caption: "Contact Center, after" },
        ]},
        ...
        { figure: [
          { src: `${IMG}/supplier/workflow-before.webp`, alt: "The old visual workflow: stage cards with checkmarks and checkboxes and no interaction", caption: "Visual Workflow, before" },
          { src: `${IMG}/supplier/workflow-after.webp`, alt: "The redesigned visual workflow: clickable stage titles, status icons with an On-Hold tooltip, and the active stage highlighted", caption: "Visual Workflow, after" },
        ]},
      ]},
      { heading: "Outcome", items: [
